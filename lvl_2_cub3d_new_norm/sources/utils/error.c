...
/*   Updated: 2021/03/13 22:31:21 by tisantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	error_message(int message)
{
	if (message == 0)
		...
		write(1, "Error\nElement NO is not well formatted or wrong order.\n", 56);
	else if (message == 9)
